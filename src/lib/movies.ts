	...
	return {
		result: [
						...
						netflix: [
							{
								...
								watchLink: "https://www.netflix.com/watch/81264660",
								audios: null,
								subtitles: null,
								price: null,
								leaving: 0,
			...
			},
			{
				type: "movie",
				title: "Selfie",
				overview: "Yasmine , Roxi and Ana run away to the seaside two days before their finals to have the time of their lives.",
				streamingInfo: {
					us: {
						netflix: [
							{
				...
				cast: ["Crina Semciuc", "Flavia Hojda", "Olimpia Melinte", "Vlad Logigan", "Alina Chivulescu", "Flavia Hojda", "Nicoleta Luciu"],
				year: 2014,
				...
				backdropURLs: {
					...
					original: "https://image.tmdb.org/t/p/original/8GEfES4eQDPXIxdOgcNiCRC0rh2.jpg",
				},
				genres: [
					{
						id: 35,
				...
				posterURLs: {
					...
					original: "https://image.tmdb.org/t/p/original/uJIMxuuzD0NoxnMvZPzrp2GJPVn.jpg",
				},
				tagline: "",
			},
			{
						...
						netflix: [
							{
								...
								watchLink: "https://www.netflix.com/watch/81260630",
								audios: null,
								subtitles: null,
								price: null,
								leaving: 0,
				...
				cast: ["Adipati Dolken", "Vanesha Prescilla", "Rendi Jhon", "Beby Tsabina", "Denira Wiraguna", "Refal Hady", "Diandra Agatha"],
				year: 2018,
				...
				backdropURLs: {
					...
					original: "https://image.tmdb.org/t/p/original/bpxvhn6WgO9qjQpWXqwx8yDeZdf.jpg",
				},
				genres: [
					{
						id: 1,
				...
				posterURLs: {
					...
					original: "https://image.tmdb.org/t/p/original/splV83B3CqMCbHUunoyaUoRUM60.jpg",
				},
				tagline: "",
			},
			{
						...
						netflix: [
							{
								...
								watchLink: "https://www.netflix.com/watch/81260637",
								audios: null,
								subtitles: null,
								price: null,
								leaving: 0,
				...
				cast: ["Adipati Dolken", "Mawar Eva De Jongh", "Vonny Cornellya Permatasari", "Sari Nila", "Ivan Leonardy", "Clay Gribble", "Sarah Sechan"],
				year: 2020,
				advisedMinimumAudienceAge: 10,
				imdbId: "tt11640412",
				imdbRating: 69,
				...
				backdropURLs: {
					...
					original: "https://image.tmdb.org/t/p/original/5Of738WV5VDjmyFtfzUjZrYuxEV.jpg",
				},
				genres: [
					{
						id: 1,
				...
				posterURLs: {
					...
					original: "https://image.tmdb.org/t/p/original/pCcvdac4PbU7U1Dgce4j9VWZ72c.jpg",
				},
				tagline: "",
			},
			{
				type: "series",
				title: "#blackAF",
				overview: "A father takes an irreverent and honest approach to parenting and relationships.",
				streamingInfo: {
					us: {
						netflix: [
							{
				...
				cast: ["Kenya Barris", "Rashida Jones", "Iman Benson", "Richard Gardenhire Jr.", "Genneya Walton", "Scarlet Spencer", "Justin Claiborne"],
				firstAirYear: 2020,
				lastAirYear: 2020,
				...
				backdropURLs: {
					...
					original: "https://image.tmdb.org/t/p/original/sSRFTSdVbpcsZV6332MzBbGky5G.jpg",
				},
				genres: [
					{
						id: 35,
				...
				posterURLs: {
					...
					original: "https://image.tmdb.org/t/p/original/xccT6BWUYLf41UNHUWdvtqdH8rN.jpg",
				},
				...
				seasons: [
					{
						...
						posterURLs: {
							...
							original: "https://image.tmdb.org/t/p/original/aSRV53GdUAMaxQP35hZaSugEjpz.jpg",
						},
						episodes: [
							{
								type: "episode",
								title: "because of slavery",
								overview: "Shooting a documentary for her NYU application, Drea introduces her unfiltered family as Kenya considers toning down his “flexing” around white people.",
								streamingInfo: {},
								cast: ["Kenya Barris", "Rashida Jones", "Iman Benson", "Richard Gardenhire Jr.", "Genneya Walton", "Scarlet Spencer", "Justin Claiborne"],
								year: 2020,
								...
								stillURLs: {
									...
									original: "https://image.tmdb.org/t/p/original/lSqvCVROgAQ1u1N5IAIBGrBCTjp.jpg",
								},
								imdbId: "",
								imdbRating: 0,
								imdbVoteCount: 0,
							...
							},
							{
								...
								overview: "On a parents’ night out, Kenya and Joya party a little too hard while at the same music festival as Chloe, whose appearance doesn't sit well with Kenya.",
								streamingInfo: {},
								cast: ["Kenya Barris", "Rashida Jones", "Iman Benson", "Richard Gardenhire Jr.", "Genneya Walton", "Scarlet Spencer", "Justin Claiborne"],
								year: 2020,
								directors: ["Ken Kwapis"],
								...
								stillURLs: {
									...
									original: "https://image.tmdb.org/t/p/original/qDegRyop90ceH0rjGg02M98c9KS.jpg",
								},
								imdbId: "",
								imdbRating: 0,
								imdbVoteCount: 0,
							...
							},
							{
								...
								overview: "Ahead of the family's Juneteenth party, Joya struggles to confront Izzy about her dance video as Kenya stresses the importance of hygiene to his sons.",
								streamingInfo: {},
								cast: ["Kenya Barris", "Rashida Jones", "Iman Benson", "Richard Gardenhire Jr.", "Genneya Walton", "Scarlet Spencer", "Justin Claiborne"],
								year: 2020,
								directors: [],
								...
								stillURLs: {
									...
									original: "https://image.tmdb.org/t/p/original/p17NdHni5fWNXQOliNWO2OflA3Q.jpg",
								},
								imdbId: "",
								imdbRating: 0,
								imdbVoteCount: 0,
							...
							},
							{
								...
								overview: "Tired of Black dads never getting praise, Kenya strives to be a more involved father by volunteering to coach a team and organizing a family night.",
								streamingInfo: {},
								cast: ["Kenya Barris", "Rashida Jones", "Iman Benson", "Richard Gardenhire Jr.", "Genneya Walton", "Scarlet Spencer", "Justin Claiborne"],
								year: 2020,
								directors: ["Ken Kwapis"],
								...
								stillURLs: {
									...
									original: "https://image.tmdb.org/t/p/original/vVDyfsFmdI0Pjzi4Hj8BaRGtY1a.jpg",
								},
								imdbId: "",
								imdbRating: 0,
								imdbVoteCount: 0,
							...
							},
							{
								...
								overview: "After criticizing a Black film, Kenya seeks out honest feedback from his family and peers. Joya worries her kids aren't embracing their Blackness.",
								streamingInfo: {},
								cast: ["Kenya Barris", "Rashida Jones", "Iman Benson", "Richard Gardenhire Jr.", "Genneya Walton", "Scarlet Spencer", "Justin Claiborne"],
								year: 2020,
								directors: [],
								...
								stillURLs: {
									...
									original: "https://image.tmdb.org/t/p/original/aV2DsyVZmnefvnxKb56wRo5KsXD.jpg",
								},
								imdbId: "",
								imdbRating: 0,
								imdbVoteCount: 0,
							...
							},
							{
								...
								overview: "As Joya promotes her book, friction between her and Kenya comes to a head when both sides start feeling like their marriage is more of a competition.",
								streamingInfo: {},
								cast: ["Kenya Barris", "Rashida Jones", "Iman Benson", "Richard Gardenhire Jr.", "Genneya Walton", "Scarlet Spencer", "Justin Claiborne"],
								year: 2020,
								directors: [],
								...
								stillURLs: {
									...
									original: "https://image.tmdb.org/t/p/original/5upBh3StdgX4LeWUV6uzIY2l9So.jpg",
								},
								imdbId: "",
								imdbRating: 0,
								imdbVoteCount: 0,
							...
							{
								type: "episode",
								title: "i know this is going to sound crazy... but this, too, is because of slavery",
								overview: "A lavish, peaceful family trip takes a turn when the kids attempt to venture outside their comfort zones and a work event puts Kenya and Joya at odds.",
								streamingInfo: {},
								cast: ["Kenya Barris", "Rashida Jones", "Iman Benson", "Richard Gardenhire Jr.", "Genneya Walton", "Scarlet Spencer", "Justin Claiborne"],
								year: 2020,
								directors: [],
								...
								stillURLs: {
									...
									original: "https://image.tmdb.org/t/p/original/yfpLonCO4zxe19k0B6rdA0y6MHX.jpg",
								},
								imdbId: "",
								imdbRating: 0,
								imdbVoteCount: 0,
							...
							{
								type: "episode",
								title: "i know you may not get this, but the reason we deserve a vacation is... because of slavery",
								overview: "As Joya takes time to focus on herself before her event, Drea tries to bond with Chloe, Pops handles an incident, and Kenya switches up his behavior.",
								streamingInfo: {},
								cast: ["Kenya Barris", "Rashida Jones", "Iman Benson", "Richard Gardenhire Jr.", "Genneya Walton", "Scarlet Spencer", "Justin Claiborne"],
								year: 2020,
								directors: [],
								...
								stillURLs: {
									...
									original: "https://image.tmdb.org/t/p/original/rfkXJPFKzR7owcooIpj4cMy34Xk.jpg",
								},
								imdbId: "",
								imdbRating: 0,
								imdbVoteCount: 0,
			...
			},
			{
				...
				cast: ["Nesta Cooper", "Keith Powers", "Alicia Sanz", "Jake Borelli", "Anne Winters", "Kate Walsh", "John Michael Higgins"],
				year: 2017,
				advisedMinimumAudienceAge: 15,
				imdbId: "tt6119504",
				imdbRating: 51,
				...
				posterURLs: {
					...
					original: "https://image.tmdb.org/t/p/original/iZliPeiiDta9KbONAhdFSXhTxrO.jpg",
				},
				tagline: "",
			},
			{
						...
						netflix: [
							{
								...
								watchLink: "https://www.netflix.com/watch/81240831",
								audios: null,
								subtitles: null,
								price: null,
								leaving: 0,
				...
				cast: ["Yoo Ah-in", "Park Shin-hye", "Lee Hyun-wook", "Jin So-yeon", "Kim Hak-sun", "So Hee-jung", "Joo Bo-bi"],
				year: 2020,
				...
				backdropURLs: {
					...
					original: "https://image.tmdb.org/t/p/original/hWpVSEMWDvG49ezvpksnS5BSnvB.jpg",
				},
				genres: [
					{
						id: 28,
				...
				posterURLs: {
					...
					original: "https://image.tmdb.org/t/p/original/zqf711LsnQ5CcW3rISFw2t7OYzb.jpg",
				},
			...
			},
			{
				...
				cast: ["Rita Dominic", "Ramsey Nouah", "Efetobore Afatakpa", "Nenye Eke", "Nelly Ekwereogo", "Ibinabo Fiberesima", "Chidi Mokeme"],
				year: 2016,
				...
				posterURLs: {
					...
					original: "https://image.tmdb.org/t/p/original/2TOA28EMpBjz4jmlpBPKvZLdwAf.jpg",
				},
				tagline: "",
			},
		],
		hasMore: true,
		nextCursor: "16094:(Un)Well",
	};
};

export const getMockedMovieDetails = () => {
	let movieDetails: IfMovie;
	movieDetails = {
		type: "movie",
		title: "#AnneFrank. Parallel Stories",
		overview:
...
export interface IfStreamingInfo {
	[key: string]: Array<IfPlatform>;
}
...
export interface IfMovie {
	...
	overview: string;
	streamingInfo: {
		[key: string]: IfStreamingInfo | undefined;
	};
	cast: Array<string>;
	year: number;
